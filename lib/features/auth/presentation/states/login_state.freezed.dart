...
class _$LoginStateImpl extends _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(isLoading: $isLoading, userName: $userName, password: $password, failure: $failure, userNameFailure: $userNameFailure, passwordFailure: $passwordFailure, validationErrorVisibility: $validationErrorVisibility)';
  }
